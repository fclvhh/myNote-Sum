> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://juejin.im/post/5c7fda1df265da2d87639be0
...
> *    [mode], 权限，如 777，表示任何用户读写可执行  
> *    callback 打开文件后回调函数，参数默认第一个 err, 第二个 fd 为一个整数，表示打开文件返回的文件描述符，window 中又称文件句柄  
>     
...
![](https://user-gold-cdn.xitu.io/2019/3/6/169536ef7c52ef01?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)